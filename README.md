...
- `index.html` is the participant experience. One shared test link allows approved testers to create a research nickname, username, and password. Login sessions are stored only on that device, and each account reads and writes only its own records.
